...
نسبت دنده & $N$ & ضرب گشتاور در $N$؛ ضرب اینرسی بازتابیده در $N^2$ \\
...
نسبت دنده $N$ در سه نقطه از معادلات ظاهر می‌شود:
\begin{itemize}
    \item گشتاور چرخ: $\tau_w = N K_t i_a$ (ضرب در $N$)
    \item اینرسی بازتابیده: $J_r N^2$ (ضرب در $N^2$)
    \item نیروی ضد محرکه: $K_e N \dot\varphi$ (ضرب در $N$)
\end{itemize}

افزایش $N$ اقتدار گشتاور را بیشتر می‌کند، اما بیشینه سرعت چرخ را کاهش و اینرسی مؤثر را افزایش می‌دهد. بهره‌هایی که برای یک مقدار $N$ تنظیم شده‌اند، مستقیماً به مقدار دیگر قابل انتقال نیستند.
